...
When you create a R markdown document like this in RStudio a bunch of example code is already written. You can compile this document (see below) to see what it looks like, but lets also create a document from scratch to understand the major components. 
