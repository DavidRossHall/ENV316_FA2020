...
```{r, eval = FALSE}
![Caption for the picture.](/path/to/image.png){width=50%}
````

Note that in the above the use of image atributes, the `{width=50%}` at the end. This is how you'll adjust the size of your image. Other dimensions you can use include `px, cm, mm, in, inch`, and `%`. 
