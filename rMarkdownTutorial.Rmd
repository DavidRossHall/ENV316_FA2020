...
What we've done here is write a snippet of R code, ran it, and printed the results. 
...
```{r, echo=false, message = false, fig.cap= "Time series of O3 and NO\\subscript(2)"}
library(tidyverse) 
